        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="hidden lg:block space-y-10 animate-in fade-in slide-in-from-left-8 duration-700">
            <div className="flex items-center gap-4 group">
              <div className="w-16 h-16 bg-slate-900/40 backdrop-blur-md rounded-2xl flex items-center justify-center p-2 shadow-2xl shadow-cyan-500/20 border-2 border-cyan-400/60 animate-logo-pulse group-hover:scale-110 transition-all duration-300">
                <img src="/images/logo.png" alt="Zerozzz ERP Logo" className="w-full h-full object-contain brightness-110 contrast-125" />
              </div>
              <div>
          ...
          <div className="animate-in fade-in slide-in-from-right-8 duration-700">
            ...
            <div className="lg:hidden flex flex-col items-center mb-10 text-center">
              <div className="w-16 h-16 bg-slate-900/40 backdrop-blur-md rounded-2xl flex items-center justify-center p-2 shadow-2xl shadow-cyan-500/20 border-2 border-cyan-400/60 animate-logo-pulse mb-4">
                <img src="/images/logo.png" alt="Zerozzz ERP Logo" className="w-full h-full object-contain brightness-110 contrast-125" />
              </div>
